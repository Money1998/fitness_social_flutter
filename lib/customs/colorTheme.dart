...
/// components.
///
/// Descendant widgets obtain the current theme's [SlidersThemeData] object using
...
/// See also:
///
///  * [SlidersThemeData], which describes the actual configuration of a slider
///    theme.
...
class SlidersTheme extends InheritedTheme {
  ...
  ///  * [SlidersThemeData], which describes the actual configuration of a slider
  ///    theme.
  static SlidersThemeData of(BuildContext context) {
    final SlidersTheme inheritedTheme = context.dependOnInheritedWidgetOfExactType<SlidersTheme>();
    return inheritedTheme != null ? inheritedTheme.data : Theme.of(context).sliderTheme;
  }

  @override
  Widget wrap(BuildContext context, Widget child) {
    final SlidersTheme ancestorTheme = context.findAncestorWidgetOfExactType<SlidersTheme>();
    return identical(this, ancestorTheme) ? child : SlidersTheme(data: data, child: child);
  }

  @override
  bool updateShouldNotify(SlidersTheme oldWidget) => data != oldWidget.data;
}

/// Describes the conditions under which the value indicator on a [Slider]
/// will be shown. Used with [SlidersThemeData.showValueIndicator].
///
/// See also:
///
...
/// [SliderComponentShape.noThumb] for [SlidersThemeData.thumbShape].
/// The overlay painting can be skipped by specifying
/// [SliderComponentShape.noOverlay] for [SlidersThemeData.overlayShape].
/// The tick mark painting can be skipped by specifying
/// [SliderTickMarkShape.noTickMark] for [SlidersThemeData.tickMarkShape].
/// The value indicator painting can be skipped by specifying the
/// appropriate [ShowValueIndicator] for [SlidersThemeData.showValueIndicator].
///
/// See also:
///
...
///  * [ThemeData], which has a default [SlidersThemeData].
/// {@macro flutter.material.slider.seeAlso.sliderComponentShape}
/// {@macro flutter.material.slider.seeAlso.sliderTrackShape}
/// {@macro flutter.material.slider.seeAlso.sliderTickMarkShape}
/// {@macro flutter.material.slider.seeAlso.rangeSliderThumbShape}
...
/// {@macro flutter.material.slider.seeAlso.rangeSliderTickMarkShape}
@immutable
class SlidersThemeData with Diagnosticable {
  /// Create a [SlidersThemeData] given a set of exact values.
  ///
  /// This will rarely be used directly. It is used by [lerp] to
  /// create intermediate themes based on two themes.
  ///
  /// The simplest way to create a SlidersThemeData is to use
  /// [copyWith] on the one you get from [SliderTheme.of], or create an
  /// entirely new one with [SlidersThemeData.fromPrimaryColors].
  ///
  /// {@tool snippet}
  ///
  /// ```dart
  ...
  /// Generates a SlidersThemeData from three main colors.
  ///
  ...
  factory SlidersThemeData.fromPrimaryColors({
  ...
  static SlidersThemeData lerp(SlidersThemeData a, SlidersThemeData b, double t) {
    assert(a != null);
    assert(b != null);
    assert(t != null);
    return SlidersThemeData(
  ...
  bool operator ==(Object other) {
    ...
    return other is SlidersThemeData
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    const SlidersThemeData defaultData = SlidersThemeData();
...
abstract class SliderComponentShape {
  ...
  /// See also:
  ///
  ///  * [SlidersThemeData.thumbShape], which is the shape that the [Slider]
  ...
  /// See also:
  ///
  ///  * [SlidersThemeData.overlayShape], which is the shape that the [Slider]
...
/// [SlidersThemeData.tickMarkShape].
///
/// See also:
///
...
abstract class SliderTickMarkShape {
  ...
  /// See also:
  ///
  ///  * [SlidersThemeData.tickMarkShape], which is the shape that the [Slider]
...
/// [SlidersThemeData] passed when getting the preferred size.
///
/// See also:
///
...
/// default sizing.
///
/// The height is set from [SlidersThemeData.trackHeight] and the width of the
/// parent box less the larger of the widths of [SlidersThemeData.thumbShape] and
/// [SlidersThemeData.overlayShape].
///
/// See also:
///
...
abstract class BaseSliderTrackShape {
  ...
  Rect getPreferredRect({
    ...
    Offset offset = Offset.zero,
    @required SlidersThemeData sliderTheme,
...
/// by the [SlidersThemeData.trackHeight]. The color is determined by the
/// [Slider]'s enabled state and the track segment's active state which are
/// defined by:
///   [SlidersThemeData.activeTrackColor],
///   [SlidersThemeData.inactiveTrackColor],
///   [SlidersThemeData.disabledActiveTrackColor],
///   [SlidersThemeData.disabledInactiveTrackColor].
///
/// {@macro flutter.material.slider.trackSegment}
///
...
///  * [SlidersThemeData], where an instance of this class is set to inform the
...
class RectangularSliderTrackShape extends SliderTrackShape with BaseSliderTrackShape {
  ...
  void paint(
    ...
    assert(isEnabled != null);
    assert(isDiscrete != null);
    // If the slider [SlidersThemeData.trackHeight] is less than or equal to 0,
...
/// [SlidersThemeData.trackHeight]. The color is determined by the [Slider]'s
...
/// defined by the [SlidersThemeData.trackHeight]. The color is determined by the
/// [Slider]'s enabled state and the track segment's active state which are
/// defined by:
///   [SlidersThemeData.activeTrackColor],
///   [SlidersThemeData.inactiveTrackColor],
...
/// the [SlidersThemeData.trackHeight]. The color is determined by the
...
class RoundSliderTickMarkShape extends SliderTickMarkShape {
  ...
  ///
  /// If it is not provided, then 1/4 of the [SlidersThemeData.trackHeight] is used.
  ...
  Size getPreferredSize({
    ...
    // [SlidersThemeData.trackHeight]. The fraction is 1/4.
...
/// [SlidersThemeData.tickMarkShape], the tick mark painting is skipped.
...
/// is specified for [SlidersThemeData.thumbShape], the thumb painting is
/// skipped.  When this value is specified for [SlidersThemeData.overlayShape],
...
/// it is visible.
///
/// The overlay color is defined by [SlidersThemeData.overlayColor].
///
/// See also:
///
...
class RoundSliderOverlayShape extends SliderComponentShape {
  ...
  ///
  /// If it is not provided, then half of the [SlidersThemeData.trackHeight] is
  /// used.
